...
<section class="boletos">
    ...
    <h2 class="boletos__descripcion">Precios para DevWebCamp</h2>

    <div class="boletos__grid">
        <div data-aos="<?php echo aos_animacion();?>" class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;DebWebCamp/></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$199</p>
        </div>
        <div data-aos="<?php echo aos_animacion();?>" class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;DebWebCamp/></h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">$49</p>
        </div>
        <div data-aos="<?php echo aos_animacion();?>" class="boleto boleto--gratis">
            <h4 class="boleto__logo">&#60;DebWebCamp/></h4>
