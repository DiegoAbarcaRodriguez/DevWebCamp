...
INSERT INTO `categorias` VALUES (1,'Conferencia'),(2,'Workshop');
...
CREATE TABLE `eventos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(120) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `descripcion` text,
...
INSERT INTO `eventos_registros` VALUES (1,6,1),(2,3,1);
...
CREATE TABLE `horas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hora` varchar(13) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `ponentes` (
  ...
  `ciudad` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `pais` varchar(20) DEFAULT NULL,
  `imagen` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `tags` varchar(120) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  `redes` text,
  PRIMARY KEY (`id`)
...
CREATE TABLE `registros` (
  ...
  `pago_id` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  KEY `registros_ibfk_3_idx` (`regalo_id`),
  ...
  CONSTRAINT `registros_ibfk_3` FOREIGN KEY (`regalo_id`) REFERENCES `regalos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `registros` VALUES (1,1,'5T3676099T3844049','e46aa7f2',3,7),(2,1,'5T3676099T3844049','e46aa7f2',3,7),(3,2,'2RA424621H705433L','72d8119c',4,1),(4,1,'5T3676099T3844049','e46aa7f2',3,7),(5,1,'5T3676099T3844049','e46aa7f2',3,5),(6,1,'5T3676099T3844049','e46aa7f2',3,5);
...
CREATE TABLE `usuarios` (
  ...
  `token` varchar(13) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `usuarios` VALUES (1,'    Diego ','Abarca','abarcarodriguezdiego@gmail.com','$2y$10$Nh2KTW4.RWScbaIw80phmureI5VxXQHt7KdeDthrX1o5zZ5Pd9FLi',1,'',1),(2,'    Diego ','Abarca','correo@gmail.com','$2y$10$Nh2KTW4.RWScbaIw80phmureI5VxXQHt7KdeDthrX1o5zZ5Pd9FLi',1,'',0),(3,'Diego ','Abarca','correo@correo.com','$2y$10$6mrv8/lGjT/8bdh4rfzOgOZN0cLJIEa3T69GuZQxXcLWLQ7U5xoFW',1,'',0),(4,'Cirenio','Perez','C@gmail.com','$2y$10$DXIbaxD2SKrQT0uq/ARPUeZfxshfDVOXmaj42187IcSCLsc0W2jG6',1,'',0);
...
-- Dump completed on 2022-12-01 17:26:03
